class Reviews < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/thkt/reviews/releases/download/v0.4.0/reviews-aarch64-apple-darwin.tar.gz"
      sha256 "db0d67aec4ca0f5d76da575452d08d2aa901ec0860c6943d1f2f2624c7b24ec4"
    end
    on_intel do
      url "https://github.com/thkt/reviews/releases/download/v0.4.0/reviews-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/thkt/reviews/releases/download/v0.4.0/reviews-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "01696e916be30ec6aac340409e121b7a082223f1e970cc7ce4f06d1f02180267"
    end
    on_intel do
      url "https://github.com/thkt/reviews/releases/download/v0.4.0/reviews-x86_64-unknown-linux-gnu.tar.gz"
